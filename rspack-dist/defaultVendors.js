(self['webpackChunkrspack_repro'] = self['webpackChunkrspack_repro'] || []).push([["defaultVendors"], {
...
(function() {
    ...
    var runInContext = function runInContext(context) {
        ...
        var DataView = getNative(context, 'DataView'), Map = getNative(context, 'Map'), Promise = getNative(context, 'Promise'), Set = getNative(context, 'Set'), WeakMap = getNative(context, 'WeakMap'), nativeCreate = getNative(Object1, 'create');
